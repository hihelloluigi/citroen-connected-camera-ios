...
@MainActor
public final class LiveLocationPermissions: NSObject, PermissionsService, CLLocationManagerDelegate {
	private let manager = CLLocationManager()
	private var pending: CheckedContinuation<PermissionStatus, Never>?

	public override init() { super.init() }

	public func locationStatus() async -> PermissionStatus { Self.map(manager.authorizationStatus) }

	public func requestLocation() async -> PermissionStatus {
